package com.akeso.depthsdk

import android.content.Context
import android.graphics.Bitmap
import com.akeso.depthsdk.utils.BitmapUtils
import com.akeso.depthsdk.utils.Logger
...
// Helper class for the MiDAS TensorFlow lite model
class MiDASDepthModel(context: Context) {

    // See the `midas_depth_sdk/src/main/assets` folder for the TFLite Model depth_model.tflite
    ...
    init {
        ...
        interpreter =
            Interpreter(FileUtil.loadMappedFile(context, modelFileName), interpreterOptions)
